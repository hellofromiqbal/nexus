    ...
    <div className='p-4 flex gap-4 border-t border-gray-700'>
      ...
      <div className='flex flex-col w-full'>
        <div className='flex items-center gap-1'>
          <Link href={`/dashboard/profile/${details?.author?.username}`} className={`text-white text-nowrap font-medium ${details?.author?.fullname.length > 12 ? 'w-[120px]' : ''} md:w-[30%] overflow-hidden text-ellipsis`}>{details?.author?.fullname}</Link>
